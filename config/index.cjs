...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxfeeddad21329b7ac',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '12ab2b09092d3b1219a32f758d36af65',
  ...
  USERS: [
    {
      ...
      id: 'oppEX6nsBnfbCPBYOhhqF6uSzX-A',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '8vcTU0A5PoptZMFKW4oXBqz6mxwmIbRA3MkgapWdang',
      // 所在省份
      province: '山东',
      // 所在城市
      city: '青岛',
